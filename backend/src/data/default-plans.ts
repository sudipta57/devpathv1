...
export const DEFAULT_JS_PLAN: DefaultPlan = {
...
export const DEFAULT_PYTHON_PLAN: DefaultPlan = {
...
export function getDefaultPlan(language = 'javascript'): DefaultPlan {
    if (language === 'python') return DEFAULT_PYTHON_PLAN;
    return DEFAULT_JS_PLAN;
}
